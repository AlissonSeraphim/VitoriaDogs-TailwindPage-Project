        ...
        <div className="container px-6 py-12 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                    ...
                    <div aria-hidden="true" className="absolute inset-x-0 bottom-0 h-16 opacity-20">
                          <div
                            className="blur-[300px] h-56 bg-gradient-to-br from-primary to-tertiary"
                          />
                          <div
                            className="blur-[200px] h-32 bg-gradient-to-r from-primary to-tertiary"
                          />
                        </div>
                    <div>
                ...
                <div className="overflow-hidden rounded-lg lg:col-span-2 h-96 lg:h-auto">
                    <iframe width="100%" height="100%" title="map" src="https://maps.google.com/maps?q=via catarina palhoça&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
                </div>
            </div>
        </div>
    </section>
