    ...
    <header className="text-primary body-font p-6 inline-block z-50">
      <div className="absolute inset-x-0 top-3 h-16 container mx-auto flex p-6 md:flex-row justify-between text-primary">
        ...
        <nav className="md:ml-auto flex flex-row items-center text-base justify-between">
          <a href="#whatsapp" className="mr-5 hover:text-secondary text-primary">
          <svg
          ...
          <a href="#instagram" className="mr-5 hover:text-secondary text-primary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
          ...
          <a href="#facebook" className="mr-5 hover:text-secondary text-primary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
          ...
          <a className="mr-5 hover:text-secondary text-primary animate-bounce" href="#contactUs">Fale Conosco</a>
        </nav>
      </div>
    </header>
  )
